...
class LanguagesForSpinner {

    private val langsEN = arrayOf("Afrikaans", "Albanian", "Amharic", "Arabic", "Armenian",
    ...
    private val langCodesEN = arrayOf("af", "sq", "am", "ar", "hy", "az", "ba", "eu",
